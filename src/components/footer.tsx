...
const Footer = () => {
  ...
  return (
    <footer className="w-full bg-[#0F172A] border-t border-gray-200 mt-20">
      <div className="max-w-8xl mx-auto py-12 px-6 md:px-12 lg:px-24">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 pb-4 gap-10">
          ...
          <div>
            ...
            <p className="mt-4 text-sm md:text-base text-[#9CA3AF] leading-6">
              Leading provider of smart identity and payment solutions across Africa.
            </p>

            <div className="flex items-center gap-4 mt-4">
              <img src="/Icons/facebook.svg" alt="Facebook" className="w-5 h-5 md:w-6 md:h-6" />
